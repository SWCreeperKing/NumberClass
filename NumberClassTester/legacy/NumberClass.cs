...
namespace NumberClassTester.legacy
{
...
#pragma warning restore 660,661
    {
        ...
        public static readonly float Version = .28f;
        ...
        private void Update()
        {
            ...
            while (mantissa is > 0 and < 1 && exponent > 1)
            {
                exponent--;
                mantissa *= 10;
            }
        ...
        {
            if (exponent < beforeSciCut) return $"{mantissa * Math.Pow(10, exponent):#,##0.##}";
